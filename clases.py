...
if __name__ == '__main__':
    try:
        ...
        ped2 = Pedido(10246, 'ALFKI',23.45,"Suiza",Empresa(1), Empleado(1))
        bd.create(ped2)

        pedido2 = bd.read(10246)
        print('Pedido2: ', pedido2)

        pedido2.pais = "Alemania"
        pedido2.importe = 120.0

        bd.update(pedido2)

        pedido3 = bd.read(10246)
        print('Pedido3: ', pedido3)
